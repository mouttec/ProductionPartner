...
const routes: Routes = [
  { path: 'calendarMouttec', component: CalendarMouttecComponent, canActivate: [AuthGuard] },
  { path: 'calendarPerso', component: CalendarPersoComponent, canActivate: [AuthGuard] },
